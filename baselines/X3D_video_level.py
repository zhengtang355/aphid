...
def main():
    ...
    parser.add_argument("--save_path", type=str, default="best_x3d_video_level.pth")
    parser.add_argument("--log_path", type=str, default="x3d_train_log.csv")
    ...
    model = build_x3d(num_classes=2, pretrained=args.pretrained).to(device)
